...
class RT_Theme_Includes
{
	...
	public static function init()
	{
		 ...
		 */
		{
			...
			/**
			 * Include all files in classes folder
			 */
			self::include_all_child_first('/classes');

			/**
			 * Include all files in config folder
			 */
			self::include_all_child_first('/config');

			/**
			 * Include all files in extensions folder
			 */
			self::include_all_child_first('/extensions');

			/**
			 * Include all files in options folder
			 */
			self::include_all_child_first('/options');
